      ...
      <div className="mt-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-semibold">Popular New Xbox Game Pass Game Being Review Bombed With “0s”</p>
              <p className="text-xs text-gray-500">Shane Doe • Jan 14, 2021 • 7,796 Views</p>
            </div>
          </div>
          <div className="flex items-center">
            <span className="text-2xl font-bold text-blue-600 mr-4">2</span>
            <div>
              <p className="text-sm font-semibold">Samsung is Developing Bright MicroLED on Displays for AR Headsets</p>
              <p className="text-xs text-gray-500">Shane Doe • Jan 14, 2021 • 6,916 Views</p>
            </div>
          </div>
          <div className="flex items-center">
            <span className="text-2xl font-bold text-blue-600 mr-4">3</span>
            <div>
              <p className="text-sm font-semibold">Warner Bros. Games Announces Mortal Kombat: Onslaught</p>
              <p className="text-xs text-gray-500">Shane Doe • Jan 14, 2021 • 5,123 Views</p>
            </div>
          </div>
        </div>
      </div>
